...
class PDFUpload extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => new _PDFUploadState();
}
...
class _PDFUploadState extends State<PDFUpload> {
  ...
  void createRecord() {
    validateAndSave();
    databaseReference.child("PDFs").push().set({
      'title': this._title,
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              new TextFormField(
                  ...
                  validator: (value) =>
                      value.isEmpty ? 'Subtitle cant be empty' : null),
              new TextFormField(
